...
f2 <- learner$new(params = list(type = ""), task = "linear", backend = "comprank")

f2$fit_pair(rec, na.omit(train[1:200,]))
...
f3$fit_pair(rec, na.omit(train[1:100,]))
preds <- f3$predict_pair(test[1:100,], "w200")
preds
```
